...
class Hyena(Animal):
    ...
    file_path = r"C:\Users\Janelle\Documents\python-cit-95-programming-spr-26-janelledowns\Module 7\animalNames.txt"
    ...
    def get_hyena_name(self):
            if self.list_of_hyena_names:  # Check if not empty
                return self.list_of_hyena_names.pop(0)
            return f"Hyena{Hyena.numOfHyenas}"  # Fallback